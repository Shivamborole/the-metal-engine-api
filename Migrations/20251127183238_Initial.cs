        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingPincode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BillingCountry = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingSame = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    ShippingPincode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceNumberSettings_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserCompanyMaps_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGstInclusive = table.Column<bool>(type: "bit", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ConvertedFromQuotationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceDocuments_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceDocuments_Companies_CompanyId1",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceDocuments_Customers_CustomerId1",
                        column: x => x.CustomerId1,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceDocuments_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaveAsProduct = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceItems_InvoiceDocuments_InvoiceDocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDocuments_CompanyId",
                table: "InvoiceDocuments",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDocuments_CompanyId1",
                table: "InvoiceDocuments",
                column: "CompanyId1");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDocuments_CreatedByUserId",
                table: "InvoiceDocuments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDocuments_CustomerId1",
                table: "InvoiceDocuments",
                column: "CustomerId1");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItems_InvoiceDocumentId",
                table: "InvoiceItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceNumberSettings_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCompanyMaps_CompanyId",
